    ...
    public partial class Customer : Form
    {
        ...
        private void Customer_Load(object sender, EventArgs e)
        {
            ...
            if (checks == true)
            {
                ...
                //criteria
                List<AdminCriteria> listReview = ac.CriteriaList("Criteria.txt");
            ...
            else
            {
                ...
                //for default Rating
                List<AdminRating> listReviews = af.RatingList("defaultRating.txt");
                ...
                List<AdminCriteria> listReview = ac.CriteriaList("defaultCriteria.txt");
                PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(AdminCriteria));
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                cr.CustomerGender = maleBtn.Text;

            }
            else if (femaleBtn.Checked)
            {
                cr.CustomerGender = femaleBtn.Text;

            }
            else if (otherBtn.Checked)
            {
                cr.CustomerGender = otherBtn.Text;
            }
            else
            {
            ...
            if (check == true)
            {
                ...
                MessageBox.Show("Successful: Thankyou for Rating.");
                if (flag == "success")
                {
        ...
        // it is to show the admin form when clicked.
